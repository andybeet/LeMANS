...
`results` is a list of several output variables (catch, recruits, M1, M2, F, spawning stock biomass, and N).
...
Visualization of output is critical. A basic plotting tool is provided to view output. The user is encouraged to write their own plotting routines. To produce a plot of catch by species for each size class with all of the species yaxes scaled to their output:
